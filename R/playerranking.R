...
#' @param col_name A column name in the dataframe to be used to rank the players

#' @return Returns a dataframe of names representing the ranking of the players based on the specified columns

#' @examples
#' rankingplayers(df,"Goals_total","Assists_Total")
rankingplayers <- function(df, col_name, ...){
